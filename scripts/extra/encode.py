...
to_address = "bYTCv3BDuQcUYzJXVYJungGTiVRLcUbfPKwwnaSK3bUmTkGNDQL1kNMWAwyudonfRATYz3vwkDHTTiqAjhmQDTjRYRAsvbXonW8"
content = """
  _____     ____
 /      \  |  o |
|        |/ ___\|
...
def rpc(method, params={}):
    ...
    try:
        ...
        print("Doesn't seem like bytech-service is running. {}".format(response))
        sys.exit(1)
