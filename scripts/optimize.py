# USAGE: Start bytech-service as you usually would
...
from bytechcoin import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="Bytechcoin address to optimize", required=True)
