...
function usage()
{
    ...
    echo "and generates the checksum files of the BytechCoin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/bytechcoin/bytechcoin.git"
CLONE_DIR="$BUILD_DIRECTORY/bytechcoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/bytechcoin-releases"
DYNAMIC_RELEASE="bytechcoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="bytechcoin-${TAG_VERSION}-linux-staticboost-CLI"
