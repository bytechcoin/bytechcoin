...
For example:
BytechCoind --print-genesis-tx --genesis-block-reward-address bYTCv3BDuQcUYzJXVYJungGTiVRLcUbfPKwwnaSK3bUmTkGNDQL1kNMWAwyudonfRATYz3vwkDHTTiqAjhmQDTjRYRAsvbXonW8
...
/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in BytechCoind. It is used to know what timestamp
...
const uint64_t MAX_EXTRA_SIZE                                = 120000;
...
const char     CRYPTONOTE_NAME[]                             = "BytechCoin";
...
const int      P2P_DEFAULT_PORT                              =  11126;
const int      RPC_DEFAULT_PORT                              =  11127;
